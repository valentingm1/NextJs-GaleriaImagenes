...
function SearchPage() {
  ...
  return (
    <div>
        ...
        <Alert>
            Esta página trae los datos <strong><a href="https://nextjs.org/docs/app/building-your-application/rendering/client-components" target="_blank" className={styles.anchor}>desde el lado del cliente.</a></strong> Para no filtrar las credenciales de la API, la petición se manda hacia un <strong><a href="https://nextjs.org/docs/app/building-your-application/routing/route-handlers" target="_blank" className={styles.anchor}>Route Handler</a></strong> que corre del lado del servidor. Este se encarga de traer la información de la API de Unsplash y luego la pasa hacia el cliente. 
        </Alert>
